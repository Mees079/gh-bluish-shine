    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold text-white flex items-center gap-2">
          <Megaphone className="h-5 w-5 text-[#337aff]" />
          Mededelingen
        </h2>
        {isBestuur && (
      ...
      <div className="space-y-3">
        {announcements.map(a => (
          <div key={a.id} className="bg-[#0e1524]/60 border border-[#25303f] rounded-xl p-5 hover:border-[#337aff]/20 transition-colors">
