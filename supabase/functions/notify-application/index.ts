...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const isSubmitted = body.event === 'submitted';
    ...
    const payload = isSubmitted
      ? {
          variables: [
            ...
            { name: 'naam', variable: '{naam}', value: body.name },
            ...
            { name: 'roblox_naam', variable: '{roblox_naam}', value: body.roblox_name ?? '-' },
